...
void lptest(string infile="", string outfile="", bool REAL=1,bool PbpMC=0,int startEntries=0,int nEntries=0){
//////////////////////////////////////////////////////////Phi
...
//////////////////////////////////////////////////////////
  ...
  if(REAL){
    ...
    //infile="/mnt/hadoop/cms/store/user/twang/HI_BfinderNtuple/20140930_PAMuon_HIRun2013_28Sep2013_v1/Bfinder_all_100_1_TdZ.";
...
printf("pt1: %f, pt2: %f, mass: %f\n", MuonInfo_pt[mu1], MuonInfo_pt[mu2], mass[size][0]);

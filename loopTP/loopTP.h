...
double dzPV1[MAX_XB];
double dzPV2[MAX_XB];
double dxyPV1[MAX_XB];
double dxyPV2[MAX_XB];
...
void buildBranch(TTree* nt){
		...
		nt->Branch("d01", d01, "d01[size]/D");  
		nt->Branch("d02", d02, "d02[size]/D");  
		nt->Branch("dz1", dz1, "dz1[size]/D");  
		nt->Branch("dz2", dz2, "dz2[size]/D");  
		nt->Branch("dxyPV1", dxyPV1, "dxyPV1[size]/D");  
		nt->Branch("dxyPV2", dxyPV2, "dxyPV2[size]/D");  
		nt->Branch("dzPV1", dzPV1, "dzPV1[size]/D");  
		nt->Branch("dzPV2", dzPV2, "dzPV2[size]/D");  
